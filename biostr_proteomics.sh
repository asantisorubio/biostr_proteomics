# install the far superior mamba binary
#conda install -y mamba
#mamba create -y -n prot
#source activate prot
...
wget -i https://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/reference_proteomes/Eukaryota/UP000005640/UP000005640_9606.fasta.gz -O resources/proteome/human.fasta.gz
